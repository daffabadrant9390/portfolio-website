    ...
    <section id="my-project" className="container mx-auto px-4 py-0 md:py-14">
      <div className="w-full ">
        ...
        <div className="grid grid-rows-4 grid-cols-1 md:grid-cols-2 md:grid-rows-2 gap-0 md:gap-6 mt-12 md:mt-20">
          ...
          <div
            data-delay="0s"
            className="anim anim-left col-span-1 row-span-1 md:mb-0 mb-4 relative"
          >
            <div className="mb-4 relative">
              <img
                src="./images/travel-lah-react-2.png"
            ...
            <h5 className="font-semibold text-white text-sm md:text-base mb-2">
              ...
              <span className="text-gray-300">
                Indonesian Travelling Website using React JS and Tailwind CSS
              </span>
            </h5>
            ...
            <a
              ...
              Travel.Lah is a travelling website design that created to introduce the best tourism destionations in Indonesia to all of the travellers over the world. The differences between this project and my last project is that i am using React JS and Tailwind CSS 3.0 to re-create the website, and also add some small animation to the home page.
              </p>
              <p class="text-sm text-gray-500 mb-8">Components: HTML5, React JS, Vanilla Javascript, Tailwind CSS 3.0</p>
              <div class="flex gap-4">
                <a href="https://travel-lah-travelling.netlify.app/" target="_blank" class="px-4 py-2 bg-green-500 rounded-lg text-white text-sm md:text-base">View Demo</a>
                <a href="https://github.com/daffabadrant9390/Travelling-App-Travel-Lah-using-React-JS-and-Tailwindcss.git" target="_blank" class="px-4 py-2 bg-red-500 rounded-lg text-white text-sm md:text-base">View Source Codes</a>
              </div>
            </div>'
            ></a>
          </div>
          ...
          <div
            data-delay="0s"
            className="anim anim-right col-span-1 row-span-1 md:mb-0 mb-4 relative"
          >
            <div className="mb-4 relative">
              <img
                src="./images/movies-omdbapi.png"
                alt="My First Project, Travel.Lah is a travelling website"
                className="w-full h-full object-cover object-left rounded-xl overflow-hidden"
              />
            </div>
            <h5 className="font-semibold text-white text-sm md:text-base mb-2">
              Movies Database:{" "}
              <span className="text-gray-300">Using React JS</span>
            </h5>
            <p className="text-gray-500 text-sm">Responsive Website</p>
            <a
              href="#"
              ...
              <p class="text-gray-300 mb-4 leading-8 text-sm md:text-base">
              On this project, i create a movies database website where we can search the movies name that we want, then it will show 10 most relatable movies that fetched from OMDb Restful API. Not only get the list of 10 most relatable movies, but also get the details of each of them. Here i also use some react hooks like useState and useEffect to control the state and the data.
              </p>
              <p class="text-sm text-gray-500 mb-8">Components: HTML5, CSS3, React JS, Vanilla Javascript</p>
              <div class="flex gap-4">
                <a href="https://movies-databases-omdbapi.netlify.app/" target="_blank" class="px-4 py-2 bg-green-500 rounded-lg text-white text-sm md:text-base">View Demo</a>
                <a href="https://github.com/daffabadrant9390/Movies-Databases-from-omdb-API-using-React-JS.git" target="_blank" class="px-4 py-2 bg-red-500 rounded-lg text-white text-sm md:text-base">View Source Codes</a>
              </div>
            </div>'
            ></a>
          </div>
